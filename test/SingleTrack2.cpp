...
int main() {
    ...
    Vx.getValue().getDerivative()[0] = 1;
    Vy.getValue().getDerivative()[1] = 1;
    phip.getValue().getDerivative()[2] = 1;
    rollp.getValue().getDerivative()[3] = 1;
    roll.getValue().getDerivative()[4] = 1;
    n.getValue().getDerivative()[5] = 1;
    alpha.getValue().getDerivative()[6] = 1;

    Cm.getValue().getDerivative()[7] = 1;
    delta.getValue().getDerivative()[8] = 1;

    std::cout << "Vx:       " << Vx.getValue().getValue() << std::endl;
    std::cout << "Vy:       " << Vy.getValue().getValue() << std::endl;
    std::cout << "Phip:     " << phip.getValue().getValue() << std::endl;
    std::cout << "Rollp:    " << rollp.getValue().getValue() << std::endl;
    std::cout << "Roll:     " << roll.getValue().getValue() << std::endl;
    std::cout << "N:        " << n.getValue().getValue() << std::endl;
    std::cout << "Alpha:    " << alpha.getValue().getValue() << std::endl;
    std::cout << "Cm:       " << Cm.getValue().getValue() << std::endl;
    std::cout << "Delta:    " << delta.getValue().getValue() << std::endl;
    std::cout << std::endl;
    ...
    std::cout << g1.getValue().getValue() << std::endl;
    std::cout << g2.getValue().getValue() << std::endl;
    std::cout << g3.getValue().getValue() << std::endl;
    std::cout << g4.getValue().getValue() << std::endl;
    std::cout << g5.getValue().getValue() << std::endl;
    std::cout << g6.getValue().getValue() << std::endl;
    std::cout << g7.getValue().getValue() << std::endl;
    std::cout << std::endl;

    std::map<std::size_t, ascalar<real>> J1 = g1.getDerivative();
    std::map<std::size_t, ascalar<real>> J2 = g2.getDerivative();
    std::map<std::size_t, ascalar<real>> J3 = g3.getDerivative();
    std::map<std::size_t, ascalar<real>> J4 = g4.getDerivative();
    std::map<std::size_t, ascalar<real>> J5 = g5.getDerivative();
    std::map<std::size_t, ascalar<real>> J6 = g6.getDerivative();
    std::map<std::size_t, ascalar<real>> J7 = g7.getDerivative();
