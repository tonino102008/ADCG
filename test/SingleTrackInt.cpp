...
int main() {
    ...
    for (size_t i = 0; i < N_STEPS; i++) {
        vars.push_back(scalar(94 / 3.6, i * (N_STATES + N_CONTROLS)));
        vars.push_back(scalar(0.0, i * (N_STATES + N_CONTROLS) + 1));
        vars.push_back(scalar(0.0, i * (N_STATES + N_CONTROLS) + 2));
        vars.push_back(scalar(0.0, i * (N_STATES + N_CONTROLS) + 3));
        vars.push_back(scalar(0.0, i * (N_STATES + N_CONTROLS) + 4));
        vars.push_back(scalar(0.0, i * (N_STATES + N_CONTROLS) + 5));
        vars.push_back(scalar(0.0, i * (N_STATES + N_CONTROLS) + 6));

        vars.push_back(scalar(0.0, i * (N_STATES + N_CONTROLS) + 7));
        vars.push_back(scalar(0.0, i * (N_STATES + N_CONTROLS) + 8));
    }

    std::vector<std::map<std::size_t, real>> J;
    ...
    for (size_t i = 0; i < N_STEPS - 1; i++) {
        ...
        J.push_back(g1.getDerivative());
        J.push_back(g2.getDerivative());
        J.push_back(g3.getDerivative());
        J.push_back(g4.getDerivative());
        J.push_back(g5.getDerivative());
        J.push_back(g6.getDerivative());
        J.push_back(g7.getDerivative());
